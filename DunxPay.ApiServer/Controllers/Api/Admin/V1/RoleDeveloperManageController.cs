...
{
    public class RoleDeveloperManageController : ApiController
    {
        private readonly IDxRoleService _dxRoleService;
        public RoleDeveloperManageController(IDxRoleService dxRoleService)
        {
        ...
        public IHttpActionResult List(RoleManageSearchCommand rolemodel)
        {
            ...
            prelicateBuilder = prelicateBuilder.And(x => x.ClientId == 2);
