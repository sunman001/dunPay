...
{
    public class RoleAgentManageController : ApiController
    {
        private readonly IDxRoleService _dxRoleService;
        public RoleAgentManageController(IDxRoleService dxRoleService)
        {
        ...
        public IHttpActionResult List(RoleManageSearchCommand rolemodel)
        {
            ...
            prelicateBuilder = prelicateBuilder.And(x => x.ClientId == 4);
